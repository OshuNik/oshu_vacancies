...
(function () {
  ...
  function containsImageMarker(s = '') {
    return /\[\s*Изображение\s*\]/i.test(String(s));
  }
  function cleanImageMarkers(html = '') {
    return String(html).replace(/\[\s*Изображение\s*\]\s*/gi, '');
  }
